...
public final class Omnivore extends Animal {
    ...
    private static final double OMNIVORE_POSSIBILITY = 60.0;
    private static final double POSSBILITY_DIV = 10.0;
    public Omnivore(final String name, final double mass, final int x, final int y) {
        super(name, mass, x, y);
    }
    @Override
    public double getAttackPossibility() {
        return (MAX_POSSIBILITY - OMNIVORE_POSSIBILITY) / POSSBILITY_DIV;
    }
